...
export class RequestContext {
     ...
     */
    public constructor(url: string, private httpMethod: HttpMethod, configuration: Configuration) {
 ...
 */
export class SelfDecodingBody implements Omit<ResponseBody, "stream"> {
...
export class ResponseContext {
     ...
     * Return as string if possible, otherwise as binary or stream.
     */
